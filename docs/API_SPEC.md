...
paths:
  ...
  /invoices:
    get:
      ...
      description: Returns invoices filtered by property, unit, tenant, month, or status, ordered by newest billing month first.
      security:
        - BearerAuth: []
      parameters:
  ...
  /invoices/generate-monthly:
    post:
      ...
      responses:
        "201":
          description: Monthly invoice generation completed and no response body was returned.
        "400":
          $ref: "#/components/responses/BadRequest"
        "401":
          $ref: "#/components/responses/Unauthorized"
...
components:
  parameters:
    ...
    InvoiceStatusQuery:
      ...
      in: query
      required: false
      description: Invoice status filter. Omit this parameter to include every invoice status.
      schema:
    ...
    InvoiceGenerateMonthlyRequest:
      ...
      properties:
        property_id:
          type: string
          format: uuid
          description: UUID of the active property to generate invoices for.
        billing_month:
          type: string
          format: date
          description: First day of the billing month. Values that are not the first day of a month are rejected.
          example: "2026-05-01"
      required:
        - property_id
        - billing_month
