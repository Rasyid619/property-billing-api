...
/*
 * Integration tests for active tenant lookup across HTTP, persistence, and token validation.
 */
class TenantAssignmentActiveTenantIntegrationTest extends AbstractIntegrationTest {
	...
	@Autowired
	TenantAssignmentActiveTenantIntegrationTest(
			MockMvc mockMvc,
	...
	@Test
	void activeTenantReturnsAssignment() throws Exception {
	...
	@Test
	void activeTenantIgnoresInactiveAssignment() throws Exception {
		tenantAssignmentRepository.save(new TenantAssignment(
	...
	@Test
	void activeTenantReturnsNotFoundWhenUnitDoesNotExist() throws Exception {
		String accessToken = jwtTokenService.createAccessToken(user);
