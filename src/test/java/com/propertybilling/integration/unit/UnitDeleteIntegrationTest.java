...
/*
 * Integration tests for unit deactivation across HTTP, persistence, and token validation.
 */
class UnitDeleteIntegrationTest extends AbstractIntegrationTest {
	...
	@Test
	void deleteDeactivatesUnit() throws Exception {
	...
	@Test
	void deleteReturnsNotFoundWhenUnitDoesNotExist() throws Exception {
		String accessToken = jwtTokenService.createAccessToken(user);
