...
/*
 * Integration tests for unit detail behavior across HTTP, persistence, and token validation.
 */
class UnitShowIntegrationTest extends AbstractIntegrationTest {
	...
	@Test
	void showReturnsUnit() throws Exception {
	...
	@Test
	void showReturnsNotFoundWhenUnitDoesNotExist() throws Exception {
		String accessToken = jwtTokenService.createAccessToken(user);
